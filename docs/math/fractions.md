...
反过来，**维度不匹配**——拆开看就是：**度不一致，所以维维系不了**。"连接的对不上"的本质不是别的，就是**度量（度）不一致**，导致关系（维）无法维持。

### 例：度量对不上，关系就维系不了

想象一对情侣分属两个部落，约定"一周见面一次"。"周"就是**度**——双方用来约定时间的标尺。

- A 部落认为"一周 = 5 天"
- B 部落认为"一周 = 7 天"

两人的"度"不一致，约定就成了空话。A 在第 5 天去等，B 在第 7 天到，永远碰不上。这不是谁对谁错，是**度量没有对齐**。久而久之，联系自然断了——**维系不住**，维就断了。

只有先把"周"对齐为一个统一的度量（比如统一为 7 天），约定才能成立，关系才能**维系**。
