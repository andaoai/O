...
/** 十天干：每个 36 度，甲从 0 度居中（-18 起） */
export const heavenlyStems: RingData = {
  startDegree: 0,
  radius: 340,
  innerRadius: 310,
  circleColor: '#888888',
  ...
  items: [
    ...
    { label: '庚', color: '#F1C40F', startAngle: 198, endAngle: 234 },    // 金，金黄
    { label: '辛', color: '#BDC3C7', startAngle: 234, endAngle: 270 },    // 金，银灰
