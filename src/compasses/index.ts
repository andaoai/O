...
export const compasses: CompassMeta[] = [
  ...
  },
  {
    id: 'huangdi-neijing',
    name: '黄帝内经·五运六气盘',
    description: '《黄帝内经·素问》七篇大论所述五运六气学说的可视化——外圈六轮甲子日刻度 / 24 节气 / 农历日期与奇门盘共用日粒度年历，内嵌主气、客气、主运、客运四环，中央信息卡显示年干支 · 岁运 · 司天 · 在泉 · 当令主客气与主客运',
    category: '术数'
  },
  {
    id: 'conjunction-cycles',
    name: '会合周期盘',
    description: '五星（水金火木土）两两会合的赤经序列——以当前时间之后最近一次会合为起点，向未来窗口内的相邻会合两点连线，越远越暗；10 对行星组合各成一色，可自由勾选。外环复用赤经刻度与七曜入宿度标记，中央整片圆域作为连线画布',
    category: '天文'
  }
]
