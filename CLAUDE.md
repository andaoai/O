...
| `QiMenLiuJiaziRing.vue` | Segment | 奇门六轮甲子 | 360 段日刻度（60 甲子 × 6 元） |
| `QiMenJuShuRing.vue` | Segment | 奇门九局数 | 阳遁 1→9 顺 / 阴遁 9→1 逆，72 段 × 5° |
| `QiMenSanYuanRing.vue` | Segment | 奇门三元 | 上中下三元循环，72 段 × 5° |
| `QiMenSolarTermsRing.vue` | Point | 奇门节气 | 24 节气 tick，落在具体日期 |
| `QiMenChaoShenJieQiRing.vue` | Segment | 超神-接气-正授 | 符头相对节气的偏移段 |
| `QiMenEightTrigramsRing.vue` | Segment | 奇门后天八卦 | 8 段方位环 |
| `QiMenFourSymbolsRing.vue` | Segment | 奇门四象 | 4 段四象环 |
| `QiMenYinYangRing.vue` | Segment | 奇门阴阳两遁 | 2 段，一阴一阳之谓道 |
...
| `QiMenInfoCenter.vue` | 奇门信息卡 | QiMenDunJiaView 圆心：阳/阴遁 · 节气 · 三元 · 局 · 超神/接气/正授状态 |
...
│   │   ├── TwentyFourMountainsRing.vue # Domain: 二十四山方位（风水盘专用）
│   │   ├── GuaRelationTextRing.vue # Domain: 卦名文字环（卦关系盘外圈）
│   │   ├── QiMenLiuJiaziRing.vue   # Domain: 奇门六轮甲子日环（360 段）
│   │   ├── QiMenJuShuRing.vue      # Domain: 奇门九局数
│   │   ├── QiMenSanYuanRing.vue    # Domain: 奇门上中下三元
│   │   ├── QiMenSolarTermsRing.vue # Domain: 奇门 24 节气点环
│   │   ├── QiMenChaoShenJieQiRing.vue # Domain: 超神/接气/正授
│   │   ├── QiMenEightTrigramsRing.vue # Domain: 奇门后天八卦
│   │   ├── QiMenFourSymbolsRing.vue # Domain: 奇门四象
│   │   └── QiMenYinYangRing.vue    # Domain: 奇门阴阳两遁
...
│   │   ├── GuaRelationCenter.vue   # GuaRelationView 中央：飞伏/互卦/对卦/综卦/交卦箭头
│   │   └── QiMenInfoCenter.vue     # QiMenDunJiaView 圆心：阳/阴遁·节气·三元·局·状态卡
